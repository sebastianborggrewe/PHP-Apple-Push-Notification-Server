...
class APNotification {
  ...
  /**
   * Sets number to be displayed in badge
   * on the app icon
   * @param int $badge
   */
  ...
  public function setPrivateKey($privateKey)
  {
    ...
    $this->_privateKeyPath = $privateKey;
  }
   ...
   * @param string $message
   * @return bool
   * @todo check wether there are any apple restrictions
   */
